...
public class MvPacket extends Packet {
	...
	public MvPacket(String str) {
		super(str);
		/*
		 * [PacketIndex(0)] public byte MoveType { get; set; } [PacketIndex(1)]
		 * public long CharacterId { get; set; } [PacketIndex(2)] public short
		 * MapX { get; set; } [PacketIndex(3)] public short MapY { get; set; }
